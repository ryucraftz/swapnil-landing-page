    ...
    return (
        <section className="bg-slate-900 pt-20 pb-32 sm:py-20 px-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                ...
                <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-purple-600/20 blur-[100px] rounded-full mix-blend-screen" />
            </div>
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
                <FadeIn>
                    <h2 className="text-white text-2xl sm:text-4xl md:text-5xl font-extrabold mb-8 leading-tight">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300 underline decoration-blue-500/50 underline-offset-4">You need a system that corrects what’s causing the pain.</span>
                    </h2>
