...
export default function FinalCTA() {
    return (
        <section className="bg-gradient-to-b from-slate-50 to-amber-50/50 py-20 px-4 relative overflow-hidden">
            {/* Glows */}
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
                <FadeIn>
                    <h2 className="text-slate-900 text-3xl sm:text-4xl md:text-5xl font-extrabold mb-8 leading-tight">
