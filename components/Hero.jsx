    ...
    <div className="relative min-h-0 md:min-h-[55vh] flex items-center justify-center overflow-hidden py-10 md:py-20 lg:py-24">
      ...
      >
        ...
        <motion.h1
          ...
          className="font-extrabold leading-[1.15] tracking-tight mx-auto text-3xl sm:text-5xl md:text-6xl lg:text-[4rem] text-slate-900 mb-6 drop-shadow-sm px-2 sm:px-0"
        >
          ...
          without <span className="relative z-10 whitespace-nowrap"><span className="absolute inset-x-0 bottom-1 h-3 bg-amber-200/40 -z-10 skew-x-[-10deg]"></span><span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-orange-600 italic font-bold">medication, surgery, or injury risk</span></span>
        </motion.h1>
        ...
        >
          Even if you’re an <span className="font-bold text-slate-900 bg-slate-100/80 px-2 py-0.5 rounded-md">entrepreneur or working professional (35–70)</span> and struggling with long-term back, knee, neck, shoulder, or joint pain,
          <br className="hidden md:block" />
