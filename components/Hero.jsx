...
export default function Hero() {
  return (
    <div className="relative min-h-0 md:min-h-[55vh] flex items-center justify-center overflow-hidden py-10 md:py-20 lg:py-24">
      ...
      {/* 🌟 Premium Aurora Background - Light Royal Theme */}
      <div className="absolute top-[-10%] left-[10%] w-[30rem] h-[30rem] bg-blue-500/30 rounded-full mix-blend-multiply filter blur-[100px] animate-blob"></div>
      <div className="absolute top-[-5%] right-[10%] w-[25rem] h-[25rem] bg-indigo-400/30 rounded-full mix-blend-multiply filter blur-[100px] animate-blob animation-delay-2000"></div>
      ...
      >
        ...
        <motion.h1
          ...
          className="font-extrabold leading-snug tracking-tight mx-auto text-3xl sm:text-5xl md:text-6xl lg:text-[4rem] text-slate-900 mb-6 drop-shadow-sm px-2 sm:px-0"
        >
          Fix chronic <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-indigo-600 to-blue-700 font-black animate-text-shimmer inline-block bg-[length:200%_auto]">Back Pain</span> so <span className="italic relative inline-block text-slate-900">YOU</span> can move, sit, walk, and sleep comfortably again
        ...
        >
          Even if you’re an <span className="font-bold text-slate-900 bg-amber-50/60 ring-1 ring-amber-100/50 px-2 py-0.5 rounded-md box-decoration-clone">entrepreneur or working professional (35–70)</span> and struggling with long-term back, knee, neck, shoulder, or joint pain,
          <br className="hidden md:block" />
