    ...
    <section className="relative bg-transparent py-10 sm:py-16 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-8 sm:mt-12">
          <FadeIn delay={0.2} className="rounded-3xl border border-blue-100 bg-white/80 backdrop-blur-2xl p-5 sm:p-8 shadow-2xl shadow-blue-900/10 transition-all duration-500 hover:shadow-blue-900/20 hover:-translate-y-1">
